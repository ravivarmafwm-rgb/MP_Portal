      ...
      <PageHeader
        ...
        actions={
          <Button variant="outline" size="sm" className="gap-1.5">
            <Download className="h-4 w-4" /> Finance Report
          </Button>
        }
      />
      <div className="space-y-6 p-4 md:p-8">
        ...
        <Card className="p-5">
          <h3 className="font-display text-base font-bold">
            Budget vs Utilization · Last 6 months (₹ Cr)
          </h3>
          ...
          <div className="mt-3 flex gap-4 text-xs text-muted-foreground">
            <span className="inline-flex items-center gap-1.5">
              <span className="h-2 w-2 rounded bg-primary/20" /> Allocated
            </span>
            <span className="inline-flex items-center gap-1.5">
              <span className="h-2 w-2 rounded bg-primary" /> Utilized
            </span>
          </div>
        </Card>
                ...
                >
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="text-muted-foreground tabular-nums">
                      ₹{v.budget}Cr · {v.projects} projects
                    </span>
                  </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-1 flex justify-between text-[11px] text-muted-foreground">
                      <span>Allocated ₹{(c.allocated / 100).toFixed(1)}Cr</span>
                      <span>Utilized ₹{(c.utilized / 100).toFixed(1)}Cr</span>
                    </div>
                  </div>
                );
              })}
