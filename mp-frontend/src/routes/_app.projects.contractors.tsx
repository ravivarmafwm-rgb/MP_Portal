  ...
  head: () => ({
    meta: [
      { title: "Contractor Management" },
      {
        name: "description",
        content:
          "Contractor intelligence center · performance, risk and assignments.",
      },
    ],
  }),
        ...
        actions={
          <>
            ...
            <Button size="sm" className="gap-1.5">
              <Plus className="h-4 w-4" /> Empanel Contractor
            </Button>
          </>
        }
      />
            ...
            <tbody>
              {contractorsData.map((c, i) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <Badge variant="secondary" className={riskTone[c.risk]}>
                      {c.risk}
                    </Badge>
                  </td>
                </motion.tr>
