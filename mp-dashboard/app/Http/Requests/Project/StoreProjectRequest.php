...
class StoreProjectRequest extends FormRequest {
 ...
 public function rules():array{return [
  'name'=>['required','string','min:3','max:255'],'project_type'=>['required','string','max:100'],'category'=>['required','string','max:100'],
  ...
  'contractor_id'=>['nullable','uuid','exists:contractors,id'],'location'=>['nullable','string','max:500'],'department'=>['nullable','string','max:255'],
