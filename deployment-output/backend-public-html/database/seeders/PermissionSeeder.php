...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $matrix = [
            ...
            'citizens.delete' => ['mp-staff', 'constituency-coordinator'],
            'citizens.export' => ['mp', 'mp-staff', 'constituency-coordinator', 'assembly-coordinator'],
            'citizens.import' => ['mp-staff', 'constituency-coordinator', 'assembly-coordinator'],
            'families.manage' => ['mp', 'mla', 'mp-staff', 'constituency-coordinator', 'assembly-coordinator', 'mandal-coordinator', 'village-coordinator', 'volunteer'],
            ...
            'volunteer_visits.view' => ['mp', 'mla', 'mp-staff', 'constituency-coordinator', 'assembly-coordinator', 'mandal-coordinator', 'village-coordinator', 'volunteer'],
            'volunteer_visits.manage' => ['mp-staff', 'constituency-coordinator'],
            'volunteer_visits.update' => ['mp-staff', 'constituency-coordinator', 'volunteer'],
