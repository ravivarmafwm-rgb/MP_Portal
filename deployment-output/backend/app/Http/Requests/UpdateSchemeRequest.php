...
class UpdateSchemeRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('update', $this->route('scheme')) ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => ['sometimes', 'required', 'string', 'max:50', Rule::unique('schemes', 'code')->ignore($scheme)],
            ...
            'application_mode' => ['sometimes', 'required', Rule::in(['online', 'offline', 'both'])],
            'approval_authority' => ['nullable', 'string', 'max:255'],
            'sla_days' => ['sometimes', 'required', 'integer', 'min:1', 'max:3650'],
